...
trait Attributes
{
    ...
    public function setErrorMode(string $mode = 'exception')
    {
        ...
        // Set Atribute
        $this->PDO->setAttribute(PDO::ATTR_ERRMODE, constant('PDO::ERRMODE_' . mb_strtoupper($mode)));
    ...
    public function setEncoding(string $case = 'utf8')
    {
        ...
        // Set Atribute
        $this->PDO->setAttribute(PDO::SQLSRV_ATTR_ENCODING, constant('PDO::SQLSRV_ENCODING_' . mb_strtoupper($case)));
